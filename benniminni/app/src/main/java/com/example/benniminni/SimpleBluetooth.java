...
public class SimpleBluetooth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.simple_blue);
        ...
        mForwardBtn = (Button)findViewById(R.id.forwardBtn);
        mBackwardBtn = (Button)findViewById(R.id.backwardBtn);
